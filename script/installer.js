...
function getInstallerConfig () {
  ...
  return Promise.resolve({
    appDirectory: path.join(outPath, 'Animal Crossing Villager Tracker-win32-ia32'),
    exe: 'Animal Crossing Villager Tracker.exe',
    ...
    setupExe: 'AnimalCrossingVillagerTracker.exe',
